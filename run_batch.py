...
# Lista de tarefas
tarefas = [
    {"modelo": "Plano_1", "nlive": 150},
    {"modelo": "Plano_f", "nlive": 200},
    {"modelo": "Curvo_1", "nlive": 200},
    {"modelo": "Curvo_f", "nlive": 250}
]
...
if __name__ == "__main__":
    ...
    try:
        # 2. Loop de Tarefas
        for job in tarefas:
            sucesso = rodar_comando(job["modelo"], job["nlive"], DIRETORIO_DO_CODIGO)
            
            nome_job = f"{job['modelo']}"
            if sucesso:
